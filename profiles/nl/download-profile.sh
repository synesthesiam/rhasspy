...
tar -xf "${acoustic_file}" "cmusphinx-nl-5.2/model_parameters/voxforge_nl_sphinx.cd_cont_2000/" && mv "${DIR}/cmusphinx-nl-5.2/model_parameters/voxforge_nl_sphinx.cd_cont_2000/" "${acoustic_output}" && rm -rf "${DIR}/cmusphinx-nl-5.2" || exit 1
